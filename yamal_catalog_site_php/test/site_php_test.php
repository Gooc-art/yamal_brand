...
assert_true($stylesTemplate !== false && str_contains($stylesTemplate, 'max-width: none'), 'styles keep home hero aligned to portal header width');
...
assert_true($frontendTemplate !== false && str_contains($frontendTemplate, "label: 'Оформление'"), 'frontend keeps style group helper for backend-compatible defaults');
...
assert_true($frontendTemplate !== false && !str_contains($frontendTemplate, 'constructor-style-more'), 'frontend hides advanced style block from constructor editor');
...
assert_true($frontendTemplate !== false && !str_contains($frontendTemplate, 'renderConstructorHandoff'), 'frontend does not render constructor handoff block');
assert_true($frontendTemplate !== false && !str_contains($frontendTemplate, 'constructor-handoff-panel'), 'frontend removed constructor handoff panel from editor');
...
assert_true($frontendTemplate !== false && !str_contains($frontendTemplate, 'Подходящие разделы'), 'frontend removed catalog guidance tail from constructor ui');
