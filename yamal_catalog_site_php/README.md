...
- сворачиваемая рабочая область с `Разделы / Каталог / Избранное`, чтобы нижний рабочий блок можно было убрать с экрана
...
- `Скрыть рабочую область` - убирает нижний блок `Разделы / Каталог / Избранное`, если нужен только презентационный экран
