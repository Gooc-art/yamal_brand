...
test('bot onboarding clearly explains official regional brand catalog context', () => {
  ...
  assert.match(botSource, /На главном экране выберите нужный раздел: «Логотип», «Фирменный стиль», «Детский логотип», «Мастер-бренд», «Паттерны», «Иллюстрации», «Шрифт», «Сувенирная продукция»\./);
