...
const SECTION_HINTS = {
  '01 Мастер-бренд Ямала': 'Утверждённый фирменный стиль региона – полный набор элементов бренда в одном месте: логотипы, знаки, шрифты, паттерны и правила их использования.\n\nДля чего использовать?\n\nОфициальные документы, презентации, сайты, социальные сети, сувенирная продукция, рекламные материалы.\n\nВыберите, что Вам необходимо',
  '02 Ямал-100': 'Юбилейный фирменный стиль к 100-летию Ямала – логотип и шрифты округа, собранные в одном месте.',
  '03 Фирменные стили МО': 'Фирменные стили муниципальных образований Ямала – логотипы, шрифты, паттерны и иллюстрации трёх городов региона: Салехарда, Нового Уренгоя и Ноябрьска.\n\nКаждый город представлен собственным набором материалов для официальных документов, презентаций и городских коммуникаций.\n\nВыберите город',
  'Салехард': 'Фирменный стиль Салехарда – единственного города в мире, расположенного прямо на Полярном круге.\n\nЛоготипы, шрифты, паттерны и иллюстрации города – для документов, презентаций и городских проектов.\n\nВыберите, что Вам необходимо',
  'Новый Уренгой': 'Фирменный стиль Нового Уренгоя – газовой столицы России.\n\nЛоготипы в разных ориентациях, фирменные шрифты, паттерны и иллюстрации города – для официальных материалов и презентаций.\n\nВыберите, что Вам необходимо',
  'Ноябрьск': 'Фирменный стиль Ноябрьска – логотипы, шрифты и городские иллюстрации в едином наборе.\n\nПригодится для документов, презентаций и любых материалов, где нужен официальный стиль города.\n\nВыберите, что Вам необходимо',
