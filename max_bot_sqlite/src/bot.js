...
const BOT_INTRO_TEXT = [
  ...
  '• Перейти к городским брендбукам и паттернам.',
  '• Добавить интересующие материалы в Избранное.',
  '• Использовать функцию Поиск для быстрого нахождения нужной информации.',
  'Просто отправьте текст: Логотип, Брендбук, Город, Паттерн, Шрифт, Сувенир — и получите доступ к необходимым ресурсам для успешного использования официального бренда Ямала.',
].join('\n\n');
